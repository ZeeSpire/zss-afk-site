  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        <p>The aperitivo typically takes place before dinner. It is a time to relax and unwind with friends or family while enjoying a drink and a light snack. We spent some incredible moments on the terrace of our hotel (Palazzo degli Abati) called <LinkExternal link="http://www.palazzodegliabati.it/crialoss" title="Link to Crialoss Café" text="Crialoss Café" />, with spectacular views over Sasso Caveoso. We sipped from a top-notch Aperol Spritz and ordered a light dinner. We tried some local foods like a trio of bruschetta and Cialledda which is a salad of cucumbers, tomatoes, onions, bread, and olive oil. It was very aromatic and fresh.</p>
        {/* image 9/16 (1000x1777) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
