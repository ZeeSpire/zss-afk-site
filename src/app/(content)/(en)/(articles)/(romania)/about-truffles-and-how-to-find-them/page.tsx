    ...
    <div>
      ...
      <main className="flex-grow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div><Image className="mb-4" src={truffles2} alt="Truffle Hunting Pin 01" width={720} height={1200} sizes="(max-width: 768px) 90vw, 35vw" /></div>
          <div><Image className="mb-4" src={truffles3} alt="Truffle Hunting Pin 02" width={720} height={1200} sizes="(max-width: 768px) 90vw, 35vw" /></div>
        </div>
      </main>
