  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        <Image className="mb-4" src={cramaDePiatraInteriorRestaurant} alt="Interior Restaurant Crama de Piatra" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        <Image className="mb-4" src={cramaDePiatraInteriorBeci} alt="Interior Crama de Piatra" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        <Image className="mb-4" src={cramaDePiatraVitaDeVie} alt="Crama de Piatra Wineyard" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
