  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        <p>We visited on a beautiful Saturday, at the end of August, just before the grape harvest. We arrived quite a while before the check-in time, but we took advantage of this and had lunch on the terrace. We ordered goulash, two types of pasta, a tomato salad with cheese, and baked potatoes with rosemary and garlic. The service was good, although not very fast, the food instead wasn’t really that great. It wasn’t bad, but let’s say that can be improved. However, I wouldn’t write off the whole experience for this, maybe it was just a thing that doesn’t happen often.</p>
