  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaRestaurant1} alt="Exquisite Culinary Symphony: A Gastronomic Journey at Noua Bucatarie Romaneasca Restaurant" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div><Image className="mb-4" src={nouaRestaurant4} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 1" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant5} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 2" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant6} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 3" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant7} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 4" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant8} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 5" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant9} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 6" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant10} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 7" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant11} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 8" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant12} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 9" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div><Image className="mb-4" src={nouaRestaurant13} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 10" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant14} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 11" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant15} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 12" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div><Image className="mb-4" src={nouaRestaurant16} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 13" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant17} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 14" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaRestaurant18} alt="Noua Bucatarie Romaneasca Restaurant - Dinner 15" width={720} height={720} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
