  ...
  return (
    ...
    <main className="flex-grow">
      <h1 className="text-center mb-8">{article.title}</h1>
        {/* image 16/9 */}
        <Image className="mb-4" src={muzeulSatului2} alt="A walk through the Dimitrie Gusti National Village Museum in Bucharest" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={muzeulSatului3} alt="Dimitrie Gusti National Village Museum in Bucharest - Inside the open air museum" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={muzeulSatului4} alt="Dimitrie Gusti National Village Museum in Bucharest - Household" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
    </main>
  </div>
  );
}
