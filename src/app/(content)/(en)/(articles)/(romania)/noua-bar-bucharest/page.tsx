  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBarOutside} alt="Noua B.A.R. - one of our favorite restaurants in Bucharest and why it impressed us" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBarBreakfast} alt="Noua B.A.R. - breakfast in the garden" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        <p>We chose:</p>
        ...
        {/* image weird */}
        <Image className="mb-4" src={nouaBar11} alt="Noua B.A.R. - inside the restaurant" width={1248} height={475} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBar4} alt="Noua B.A.R. - Basket with two types of homemade bread and butter" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBar10} alt="Noua B.A.R. - Homemade burrata with salad from Grădina Corbilor" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBar2} alt="Noua B.A.R. - Chicken schnitzel with mushroom sauce and green salad" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={nouaBar3} alt="Noua B.A.R. - Elderflower ice cream" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div><Image className="mb-4" src={nouaBar7} alt="Noua B.A.R. - Inside the restaurant 1" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaBar1} alt="Noua B.A.R. - Inside the restaurant 2" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={nouaBar6} alt="Noua B.A.R. - Inside the restaurant 3" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
      </main>
    </div>
  );
