  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={valeaVerde} alt="The full New Year's Eve Experience at Valea Verde Retreat: from timeless Transylvania to the reality check" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority />
        ...
        <p>We had been to Valea Verde Retreat about a year ago to participate in a truffle hunting activity. I detailed the entire experience in <Link prefetch={false} href="/valea-verde-a-successful-story-of-reviving-a-forgotten-transylvanian-village" className="text-blue-600 underline hover:text-blue-800">this article</Link>.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div><Image className="mb-4" src={valeaVerde3} alt="Horses at Valea Verde" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={valeaVerde1} alt="Aerial foto of Targu Mures" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-4" src={valeaVerde2} alt="Medias from above" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
        <h2>Accommodation</h2>
        ...
        <Image className="mb-4" src={valeaVerde4} alt="Valea Verde in the yard" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        <h2>Food</h2>
        <h3>Breakfast</h3>
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={valeaVerde5} alt="Breakfast at Valea Verde" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        <h3>Dinner</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <div><Image className="mb-4" src={valeaVerde11} alt="Valea Verde - Quail egg with fried bacon, truffles, and chives" width={720} height={720} sizes="(max-width: 768px) 90vw, 15vw" /></div>
          <div><Image className="mb-4" src={valeaVerde12} alt="Valea Verde - Quinoa salad" width={720} height={720} sizes="(max-width: 768px) 90vw, 15vw" /></div>
          <div><Image className="mb-4" src={valeaVerde13} alt="Valea Verde - Pea cream soup" width={720} height={720} sizes="(max-width: 768px) 90vw, 15vw" /></div>
          <div><Image className="mb-4" src={valeaVerde14} alt="Valea Verde - Beef bourguignon" width={720} height={720} sizes="(max-width: 768px) 90vw, 15vw" /></div>
          <div><Image className="mb-4" src={valeaVerde15} alt="Valea Verde - Sour cherry sorbet" width={720} height={720} sizes="(max-width: 768px) 90vw, 15vw" /></div>
        </div>
        ...
        {/* image 16/9 */}
        <Image className="mb-4" src={valeaVerdeRevelion} alt="Valea Verde - New Year’s Eve Party" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
