...
export default function Page() {
  return (
    ...
    <main className="flex-grow">
      ...
      {/* image 16/9 */}
      <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesFourthOfJuly} alt="Exploring the Fragrant Beauty of Bulgaria's Valley of Roses" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority/>
        <p>Last year, at the end of May, we had the pleasure of attending the Rose Festival in Bulgaria, located in the Kazanlak region, famously known as the Valley of Roses. We’ve shared more details about our accommodations and the places we visited in <Link prefetch={false} href="/bulgaria-rose-valley-rose-festival" title="Embark on an Enchanting Journey Through Bulgaria's Rose Valley" className="text-blue-600 underline hover:text-blue-800">this article</Link>.</p>
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesDamascRose} alt="Bulgaria Valley of Roses - Damasc Rose" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesRoseFestival} alt="Bulgaria Valley of Roses - Rose Festival" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesDoubleDelightRose} alt="Bulgaria Valley of Roses - Double Delight Rose" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesGoldenCelebrationRose} alt="Bulgaria Valley of Roses - Golden Celebration Rose" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesOrangeRose} alt="Bulgaria Valley of Roses - Orange Rose" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={bulgariaValleyofRosesWhiteRose} alt="Bulgaria Valley of Roses - White Rose" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
    </main>
  </div>
  );
}