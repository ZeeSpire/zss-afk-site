...
export default function Page() {
  return (
    ...
    <main className="flex-grow">
      ...
      {/* image 16/9 */}
      <Image className="mb-6 rounded-lg drop-shadow-xl" src={lecceABaroqueGemInSalento} alt="Lecce - the Baroque gem of Salento" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" priority />
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={lecceBaroqueBuilding} alt="Lecce - Baroque Building" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div><Image className="mb-6 rounded-lg drop-shadow-xl" src={lecceStrollStreets} alt="Lecce - Streets Stroll" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
          <div><Image className="mb-6 rounded-lg drop-shadow-xl" src={lecceBalcony} alt="Lecce - Balcony" width={720} height={1279} sizes="(max-width: 768px) 90vw, 20vw" /></div>
        </div>
        ...
        {/* image 16/9 */}
        <Image className="mb-6 rounded-lg drop-shadow-xl" src={lecceRomanAmphitheatre} alt="Lecce - Roman Amphitheatre" width={1248} height={702} sizes="(max-width: 1280px) 90vw, 70vw" />
