  ...
  return (
    <div>
      ...
      <main className="flex-grow">
        ...
        <p>Prima dată am fost la Noua Bucătărie Românească în aprilie 2022. Link <Link prefetch={false} href="/ro/noua-bucatarie-romaneasca" title="Noua - Un restaurant la alt nivel în București" className="text-blue-600 underline hover:text-blue-800">aici</Link> cu articolul de atunci. Am fost plăcut surprinşi să descoperim că nu au scăzut calitatea mâncării sau a servirii, ci chiar au îmbunătăţit-o. Mai mult, pe parcursul acestei perioade, i-am urmărit pe rețelele de socializare, și astfel știm că au participat activ la competiții, au câștigat premii, au organizat sau au fost invitați la diverse evenimente culinare, atât în România, cât și în străinătate, implicându-se în schimburi valoroase cu alți bucătari recunoscuți.</p>
        <p>La finalul anului 2022, a apărut pe lume şi fratele mai mic: Noua B.A.R. (abrevierea de la Bucătărie Aproape Românească). Despre acesta avem un <Link prefetch={false} href="/ro/noua-bar-bucuresti" title="Noua B.A.R. - unul din restaurantele noastre preferate din Bucureşti şi de ce ne-a impresionat" className="text-blue-600 underline hover:text-blue-800">articol separat</Link>. Dacă nu-ţi doreşti o experienţa fine dining cu un meniu de degustare aşa cum oferă Noua Restaurant, atunci poţi opta pentru Noua B.A.R. unde se poate comanda à la carte.</p>
