  ...
  return (
    <div>
      ...
      <main className="flex-grow">
            ...
            <div className="card bg-base-100 shadow-xl" key={article.id}>
              <figure>
                <Link  prefetch={false} href={`${article.slug?.ro}`}>
                  <Image src={article.featured} alt={article.titleRo} width={705} height={705} sizes="(max-width: 768px) 90vw, (max-width: 1024px) 35vw, 25vw" priority={index === 0}/>
                </Link>
              </figure>
        ...
        <Pagination baseUrl="/ro/pagina" page={page} perPage={pageConfig.itemsPerPage} total={pageConfig.totalItems} offset={pageConfig.offset} />
      </main>
    </div>
  );
}
