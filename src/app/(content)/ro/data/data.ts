...
export function getArticles(): Article[] {
  return [
    {
      slug: "ro/explorand-frumusetea-parfumata-a-vaii-trandafirilor-din-bulgaria",
      title: "Explorând frumusețea parfumată a Văii Trandafirilor din Bulgaria",
      featured: bulgariaRoseValleyRosesFourthJulySquare,
      featuredLandscape: bulgariaRoseValleyRosesFourthJuly,
      category: "Bulgaria"
    },
    {
      slug: "ro/bulgaria-valea-trandafirilor-festivalul-trandafirilor",
      title: "O călătorie fermecătoare prin Valea Trandafirilor din Bulgaria",
    ...
    {
      slug: "ro/valea-verde",
      title: "Experiența completă de Revelion la Valea Verde Retreat: de la Transilvania veșnică la realitatea crudă",
      featured: valeaVerde2Square,
      featuredLandscape: valeaVerde2,
      category: "Romania"
    },
    {
      slug: "ro/simfonie-culinara-exceptionala-o-calatorie-gastronomica-la-noua-bucatarie-romaneasca",
      title: "Simfonie Culinară Excepțională: O Călătorie Gastronomică la Noua Bucătărie Românească",
      featured: exquisiteCulinarySymphonySquare,
      featuredLandscape: exquisiteCulinarySymphony,
      category: "Romania"
    }, {
      slug: "ro/cina-la-the-artist-un-festin-vizual-cu-loc-de-mai-bine",
      title: "Cina la The Artist: un ospăț vizual cu loc de mai bine",
      featured: dinnerAtTheArtistSquare,
      featuredLandscape: dinnerAtTheArtist,
      category: "Romania"
    },
    {
      slug: "ro/ce-sa-vizitezi-in-salonic",
      title: "Ce poţi face în Salonic în doar trei ore",
      featured: whatYouCanDoInThessalonikiSquare,
      featuredLandscape: whatYouCanDoInThessaloniki,
      category: "Greece"
    },
    {
      slug: "ro/top-lucruri-de-facut-in-atena",
      title: "Top 15 lucruri de făcut în Atena plus alte recomandări",
      featured: top15ThingsToDoInAthensSquare,
      featuredLandscape: top15ThingsToDoInAthens,
      category: "Greece"
    },
    {
      slug: "ro/gradina-cismigiu",
    ...
    {
      slug: "ro/muzeul-satului-dimitrie-gusti-bucuresti",
    ...
    {
      slug: "ro/lecce-bijuteria-baroca-din-salento",
    ...
    {
      slug: "ro/totul-despre-matera-italia",
    ...
    {
      slug: "ro/oferte-de-paste-in-romania-2023",
    ...
    {
      slug: "ro/valea-verde-o-poveste-de-succes-a-reinvierii-unui-sat-transilvanean-uitat",
    ...
    {
      slug: "ro/despre-trufe-si-gasirea-lor",
    ...
    {
      slug: "ro/art-safari-o-expozitie-temporara-de-arta-in-bucuresti-editia-10",
    ...
    {
      slug: "ro/vanatoare-de-trufe-si-o-experienta-culinara-deosebita-la-conacul-grigorescu",
    ...
    {
      slug: "ro/viscri-cel-mai-popular-sat-sasesc-din-transilvania",
    ...
    {
      slug: "ro/crama-de-piatra-o-crama-boutique-cu-un-potential-imens",
    ...
    {
      slug: "ro/top-lucruri-de-facut-in-santorini-grecia",
    ...
    {
      slug: "ro/cele-mai-bune-locuri-de-privit-apusul-in-santorini",
    ...
    {
      slug: "ro/ce-si-unde-sa-mananci-in-santorini",
      title: "Ce și unde să mănânci în Santorini",
      featured: whatAndWhereToEatInSantoriniSquare,
      featuredLandscape: whatAndWhereToEatInSantorini,
      category: "Grecia"
    },
    {
      slug: "ro/despre-divine-cave-experience-din-santorini",
    ...
    {
      slug: "ro/festivalul-neversea-editia-2022",
    ...
    {
      slug: "ro/art-safari-o-expozitie-temporara-de-arta-in-bucuresti",
    ...
    {
      slug: "ro/cazari-izolate-in-romania",
    ...
    {
      slug: "ro/noua-bucatarie-romaneasca",
    ...
    {
      slug: "ro/vulcanii-noroiosi-judetul-buzau-romania",
    ...
    {
      slug: "ro/castelul-frederiksborg-excursie-de-o-zi-din-copenhaga",
    ...
    {
      slug: "ro/trei-zile-in-copenhaga",
    ...
    {
      slug: "ro/atractii-gratuite-de-vizitat-in-copenhaga",
    ...
    {
      slug: "ro/sfaturi-pentru-prima-vizita-in-copenhaga",
    ...
    {
      slug: "ro/satele-magura-si-pestera-din-brasov-romania",
